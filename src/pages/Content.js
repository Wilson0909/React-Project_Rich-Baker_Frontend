  ...
  return (
    <>
        ...
        <nav className="container flex items-center justify-between h-16 sm:h-20">
            <div className="zoom font-Lobster sm:text-2x1">
                RichBakers.
            </div>
        ...
        <section id="home" className="relative">
            <div className="container">
                <div className="w-64 h-64 bg-amber-400 rounded-full blur-3xl -z-10 opacity-40 absolute top-1/2
                left-1/2 transform -translate-x-1/2 -translate-y-1/2">

                </div>

                <div className="w-64 h-64 bg-amber-400 rounded-full blur-3xl -z-10 opacity-40 absolute right-0 bottom-0">
